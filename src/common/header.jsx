...
export const MainHeader = () => {
  ...
  return(    
      <nav className="navbar navbar-expand-lg navbar-light bg-light">        
        ...
        <div className="d-lg-none d-mobile-only-header">
        ...
        <a type="" className="btn btn-spl-default notification-present">
        <span className="notification--red circle"></span>
          <span className="fas fa-comment"></span>
        </a>
        <div className="dropdown dropdown-left-link d-inline-block">
        <a className="btn btn-spl-default notification-present" href="#" data-toggle="dropdown">
          <span className="notification--red circle"></span>
